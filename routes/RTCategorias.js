...
const {obtenerCategorias, unaCategoria, insertarCategoria, modificarCategoria, eliminarCategoria} = require("../controller/categoriasCT.js");
...
router.put('/editarCategoria', authAdmin, modificarCategoria);
